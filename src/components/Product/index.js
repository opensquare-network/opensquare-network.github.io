    ...
    <div className="font-inter md:mb-20">
      ...
      <Row className="md:flex md:w-1080px md:mx-auto md:mt-10">
        ...
        <div className=" md:flex md:flex-wrap md:mt-9">
          <div className="relative w-346px m-auto pt-6 pr-7 pl-15 pb-6 shadow-lg mb-16 md:mb-0">
            <img
              src={Bounty}
              alt=""
          ...
          <div className="relative w-346px md:ml-76px m-auto pt-6 pr-7 pl-15 pb-6 shadow-lg">
            <img
              src={Vote}
              alt=""
              className="p-4 shadow bg-white absolute -top-9 -left-9 "
